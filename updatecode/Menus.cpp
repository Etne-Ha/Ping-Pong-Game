...
void Start_new(SDL_Window*& window, SDL_Renderer*& renderer, string name, string file_name)
{
	...
	Ball b((float)(_left + _right) / 2, (float)(_top + _bot) / 2, "init\\ball.png", renderer, DOWN); // tạo trái banh
...
{
	Pong Game(140, 140 + 560, 440, 840, PLAYING); // tạo một vật thể thuộc lớp game pong với chiều rộng == 40 và chiều cao == 30 với trạng thái vào game là INTRO 
