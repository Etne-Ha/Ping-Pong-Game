...
void Pong::runGame(SDL_Window*& window, SDL_Renderer*& renderer)
{
	...
	Ball b((float)(_right + _left) / 2, (float)(_top + _bot) / 2, SPEED, "init\\ball.png", renderer, DOWN); // tạo trái banh
	...
	this->_playerTop->draw(renderer); // vẽ thanh trượt trên 
	this->_playerBottom->draw(renderer); // vẽ thanh trượt dưới
	this->_ball->draw(renderer); // vẽ trái banh
