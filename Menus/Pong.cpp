...
void Pong::runGame(SDL_Window*& window, SDL_Renderer*& renderer)
{
	...
	const char* sh = "P2  Victory";
	const char* sh2 = "P1 Victory";
	if (_playerBottom->Score() == 3)
		shit = TTF_RenderText_Solid(font1, sh2, color);
	else
		shit = TTF_RenderText_Solid(font1, sh, color);
