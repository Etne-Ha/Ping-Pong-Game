...
public:
	...
	void move(Paddle* playerBottom_info, Paddle* playerTop_info);
	...
	Ball(float x, float y, float speed, string path, SDL_Renderer*& gRenderer, balldirection ball_dir);
	...
	bool impactWall(int top, int bot, int left, int right);
