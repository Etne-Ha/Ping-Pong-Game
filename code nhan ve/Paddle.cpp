...
Paddle::Paddle(int x, int y, int size, int left_limit, int right_limit, paddledirection paddle_dir = NONE)
{
	this->_paddle_original_pos.x = x; // gán x cho x gốc 
	this->_paddle_original_pos.y = y; // gán y cho y gốc
	this->_paddle_pos.x = x; // gán x cho x hiện tại
	this->_paddle_pos.y = y; // gán y cho y hiện tại
